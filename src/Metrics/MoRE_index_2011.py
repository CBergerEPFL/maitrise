...
def Matrix_Regularity(all_lead,N_channels,N_signal,segLen,segNum,upperbnd,lowerbnd,LDdv_th,missWeigth,flatweigth,ldWeigth):
    ...
    for j in range(N_channels):
        ...
        flatTest = Flatsegment_detection(all_lead,j,segNum,segLen,upperbnd,lowerbnd)
